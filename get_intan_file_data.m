function [amplifier_data,t_amplifier,frequency_parameters,board_dig_in_data,t_dig] = get_intan_file_data(file,path)
...
[file, path, filterindex] = ...
    uigetfile('*.rhd', 'Select an RHD2000 Data File', 'MultiSelect', 'on','/nas/data3/');path
end
