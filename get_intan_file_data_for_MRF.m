function [summary] = get_intan_file_data_for_MRF(strFileName)
...
%                     fprintf(1, '%d%% done...\n', percent_done);
    ...
    summary = struct;
    summary.amplifier_data = amplifier_data;
    summary.t_amplifier = t_amplifier;
    summary.board_dig_in = board_dig_in_data;
    summary.t_dig = t_dig;
    summary.frequency_parameters = frequency_parameters;
    summary.spike_triggers = spike_triggers;
