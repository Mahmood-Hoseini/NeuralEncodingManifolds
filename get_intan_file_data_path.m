function [amplifier_data,t_amplifier,frequency_parameters,board_dig_in_data,t_dig,path] = get_intan_file_data(file,path)
% [amplifier_data,t_amplifier,frequency_parameters,board_dig_in_data,t_dig] = get_intan_file_data(file,path)
% [amplifier_data,t_amplifier,frequency_parameters] = get_intan_file_data(file,path)
%

% choose one or multiple files
if nargin < 2
[file, path, filterindex] = ...
    uigetfile('*.rhd', 'Select an RHD2000 Data File', 'MultiSelect', 'on','/nas/data3/');
end
